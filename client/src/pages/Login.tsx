        ...
        <div style={{position: 'absolute', height: 100 + 'vh', width: 100 + 'vw', backgroundColor: '#232323'}}>
            <div style={{
                ...
                <div style={{marginLeft: 40}}>
                    <Typography style={{fontSize: 30, textAlign: 'left', marginTop: 30, fontWeight: '400'}} variant="h2"
                                component="h2">
                        Invoice generator
                    </Typography>
                    <Typography style={{fontSize: 50, textAlign: 'left', marginTop: 30, fontWeight: '400'}} variant="h2"
                                component="h2">
                        Se connecter
                    </Typography>
                ...
                >
                    ...
                    <FormControl onSubmit={handleSubmit} sx={{m: 1, width: '25ch'}} variant="standard">
                        ...
                        <Button sx={{marginTop: 5}} variant="contained"
                                onClick={handleSubmit}>connexion</Button>
                    </FormControl>
                </Stack>
            </div>
            <div style={{maxWidth:'24rem', margin:'auto', padding: '1rem'}}>
                <img style={{width:100+'%', objectFit:'cover', borderRadius:'inherit', backgroundImage: `url(${url})`}} alt={""}></img>
